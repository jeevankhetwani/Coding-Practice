...
//int findPeakRec(int arr[][MAX], int rows, int low,
//                int high)
//{
...
//    if (mid  == 0 || max >= arr[max_index][mid-1] &&
//        max >= arr[max_index][mid+1])
//        return max;
//
//    // If max is less than its left
//    if (max < arr[max_index][mid-1])
//        return findPeakRec(arr, rows, low, mid - 1);
//
//    // If max is less than its left
//    // if (max < arr[max_index][mid+1])
//    return findPeakRec(arr, rows, mid + 1, high);
//}
//
//// A wrapper over findPeakRec()
//int findPeak(int arr[][MAX], int rows, int columns)
//{
//    return findPeakRec(arr, rows, 0, columns - 1);
//}
//
//// Driver Code
//int main()
